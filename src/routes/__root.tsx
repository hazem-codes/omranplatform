...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "عمران - عمر بيتك بإحترافية" },
      { name: "description", content: "عمران هي منصة تربط أصحاب المشاريع بالمكاتب الهندسية المعتمدة في المملكة العربية السعودية" },
      { property: "og:title", content: "عمران - عمر بيتك بإحترافية" },
      { property: "og:description", content: "عمران هي منصة تربط أصحاب المشاريع بالمكاتب الهندسية المعتمدة في المملكة العربية السعودية" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "عمران - عمر بيتك بإحترافية" },
      { name: "twitter:description", content: "عمران هي منصة تربط أصحاب المشاريع بالمكاتب الهندسية المعتمدة في المملكة العربية السعودية" },
